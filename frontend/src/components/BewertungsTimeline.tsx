        ...
        <div className="space-y-4">
          {mockBewertungen.slice(0, visibleBewertungen).map((bewertung) => (
            <div key={bewertung.id} className="border border-gray-100 rounded-lg p-4 bg-white hover:bg-gray-50 transition-colors">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex">
                    {[...Array(5)].map((_, index) => (
                      <svg
                        key={index}
                        className={`w-4 h-4 ${index < bewertung.sterne ? 'text-yellow-400' : 'text-gray-200'}`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
              ...
              {bewertung.antwort && (
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-md mb-3 text-sm">
